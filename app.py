...
app.config['JWT_SECRET_KEY'] = "ATCEEAFMTO2345689975412365413"
...
app.config["EMAIL_HOST_USER"] = "{YOUR COMPANY EMAIL HERE}"
app.config["MAIL_USERNAME"] = "{YOUR COMPANY EMAIL HERE}"
app.config["MAIL_PASSWORD"] = "{YOUR COMPANY EMAIL PASSWORD HERE}"
